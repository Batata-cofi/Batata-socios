...
const COMBOS = [
  {nombre:"Latte + Cookie",          tipo:"Desayuno",pv:8000, ct:6679,rent:16.5,u:45,accion:"subir",  nota:"Precio bajo para el margen. Subir $500 no afecta la percepción de valor."},
  {nombre:"Café c/leche + Cookie",   tipo:"Desayuno",pv:8000, ct:6393,rent:20.1,u:38,accion:"ok",    nota:"Margen aceptable. Mantener y comunicar más."},
  {nombre:"Latte + Tostadas",        tipo:"Desayuno",pv:9900, ct:9237,rent:6.7, u:12,accion:"revisar",nota:"Margen crítico (6.7%). Subir a $11.500 o revisar el costo de tostadas."},
  {nombre:"Café c/leche + Tostadas", tipo:"Desayuno",pv:9900, ct:8951,rent:9.6, u:8, accion:"revisar",nota:"Margen bajo. Evaluar subida de precio junto con Latte + Tostadas."},
  {nombre:"Latte + Tostado",         tipo:"Desayuno",pv:12300,ct:10870,rent:11.6,u:18,accion:"subir", nota:"Buen volumen pero margen ajustado. Subir a $13.500."},
  {nombre:"Latte + Chipa",           tipo:"Desayuno",pv:8000, ct:6829,rent:14.6,u:55,accion:"subir",  nota:"El más vendido del desayuno. Subir $500 sin riesgo."},
  {nombre:"Café c/leche + Chipa",    tipo:"Desayuno",pv:8000, ct:6543,rent:18.2,u:32,accion:"ok",    nota:"Margen correcto. Potenciar en comunicación."},
  {nombre:"Latte + Alfajor Alm.",    tipo:"Desayuno",pv:8000, ct:6363,rent:20.5,u:22,accion:"ok",    nota:"Mejor margen del desayuno. Empujar en venta sugestiva."},
  {nombre:"Sandwich Bondio + Beb.",  tipo:"Almuerzo",pv:19000,ct:13129,rent:30.9,u:8,accion:"revisar",nota:"Sandwich Bondio sale pronto de carta. Evaluar reemplazar combo."},
  {nombre:"Sandwich Mortadela + Beb.",tipo:"Almuerzo",pv:16500,ct:12714,rent:22.9,u:15,accion:"ok",  nota:"Buen margen. Mantener y potenciar cuando salga el Bondio."},
  {nombre:"Sandwich Veggie + Beb.",  tipo:"Almuerzo",pv:16500,ct:12429,rent:24.7,u:6, accion:"revisar",nota:"Sandwich Veggie sale pronto de carta. Planificar reemplazo."},
];
          ...
          <div>
            ...
            <div style={{background:C.card,borderRadius:12,padding:"18px 16px",border:`1px solid ${C.border}`,marginBottom:16}}>
              ...
              <ResponsiveContainer width="100%" height={200}>
                <BarChart data={DIAS_MAYO.map(d=>({f:`${d.dia}`,v:d.v}))} margin={{top:0,right:0,bottom:0,left:0}}>
                  <CartesianGrid strokeDasharray="3 3" stroke={C.border} vertical={false}/>
                  <XAxis dataKey="f" tick={{fontSize:9,fill:C.muted}} tickLine={false} axisLine={false}/>
                  <YAxis tick={{fontSize:9,fill:C.muted}} tickLine={false} axisLine={false} tickFormatter={v=>v>0?`$${Math.round(v/1000)}k`:""}/>
                  <Tooltip formatter={(v,n,p)=>[v>0?fmt(v):"Sin operación","Ventas"]} labelFormatter={l=>`Día ${l} de mayo`} contentStyle={{background:C.card2,border:`1px solid ${C.border}`,borderRadius:8,fontSize:11}}/>
                  <Bar dataKey="v" radius={[3,3,0,0]}>
                    {DIAS_MAYO.map((d,i)=><Cell key={i} fill={!d.activo?C.dim:[0,6].includes(new Date(2026,4,d.dia).getDay())?C.accent:C.blue}/>)}
                  </Bar>
                </BarChart>
              </ResponsiveContainer>
